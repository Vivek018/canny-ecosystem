export const payrollColumns = [
  {
    ...
    cell: ({ row }) => {
      return (
        <p className="truncate capitalize w-48">{`${row.original?.name ?? "--"}`}</p>
      );
    },
  },
  ...
  },
  {
    ...
    cell: ({ row }) => {
      return (
        <p className="truncate  capitalize">{row.original?.gross_pay ?? ""}</p>
      );
    },
  },
  {
    ...
    header: "Taxes",
    cell: ({ row }) => {
      return <p className="truncate ">{row.original?.taxes ?? "--"}</p>;
    },
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      return (
        <p className="capitalize truncate">{row.original?.site_name ?? "--"}</p>
      );
    },
  },
  {
    ...
    cell: ({ row }) => {
      return (
        <p className="capitalize truncate">{row.original?.area ?? "--"}</p>
      );
    },
  },
];
