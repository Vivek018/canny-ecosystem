...
export const DeletePaymentTemplate = ({
  ...
  const handleCancelPaymentTemplate = () => {
    setInputError([]);
    setInputValue("");
    setLoading(false);
  };
    ...
    <AlertDialog>
      <AlertDialogTrigger
        className={cn(
          ...
          hasPermission(role, `${deleteRole}:${attribute.paymentTemplates}`) && "flex"
        )}
      >
      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter>
          <AlertDialogCancel onClick={handleCancelPaymentTemplate}>
            Cancel
          </AlertDialogCancel>
          <AlertDialogAction
            className={cn(buttonVariants({ variant: "destructive" }))}
            onClick={handleDeletePaymentTemplate}
            onSelect={handleDeletePaymentTemplate}
          >
