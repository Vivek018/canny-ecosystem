...
export const ImportedDataColumns: ColumnDef<ImportExitDataType>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      return <p className="truncate ">{row.original?.project_site_name ?? "--"}</p>
    },
  },
  {
    ...
    cell: ({ row }) => {
      return <p className="truncate ">{row.original?.last_working_day ?? "--"}</p>
    },
  },
  {
    accessorKey: "reason",
  ...
  },
  {
    ...
    cell: ({ row }) => {
      return <p className="truncate ">{row.original?.leave_encashment ?? "--"}</p>
    },
  },
  {
