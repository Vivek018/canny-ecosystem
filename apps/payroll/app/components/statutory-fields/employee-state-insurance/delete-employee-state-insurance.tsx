...
export const DeleteEmployeeStateInsurance = ({ employeeStateInsuranceId }: { employeeStateInsuranceId: string }) => {
    const [isLoading, setLoading] = useState(false);
    const [inputValue, setInputValue] = useState("");
    const [inputError, setInputError] = useState<string[]>([]);
    const submit = useSubmit();

    const handleCancelESI = () => {
        setInputError([]);
        setInputValue("");
        setLoading(false);
    };
        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        This action cannot be undone. This will permanently delete your ESI and remove it's data from our servers.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <div className="py-4">
                ...
                <AlertDialogFooter>
                    <AlertDialogCancel onClick={handleCancelESI}>
                        Cancel
                    </AlertDialogCancel>
                    <AlertDialogAction
                        className={cn(buttonVariants({ variant: "destructive" }))}
                        onClick={handleDeleteESI}
                        onSelect={handleDeleteESI}
                    >
