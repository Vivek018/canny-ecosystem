...
export const DeletePaymentField = ({
  paymentFieldId,
}: {
  ...
  const handleDeletePaymentField = (
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            payment field and remove it's data from our servers.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <div className='py-4'>
        ...
        <AlertDialogFooter>
          <AlertDialogCancel onClick={handleCancelPaymentField}>
            Cancel
          </AlertDialogCancel>
          <AlertDialogAction
