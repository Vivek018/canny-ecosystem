...
import type { ESIReportFilters } from "@/routes/_protected+/reports+/esi+/_index";
import { payoutMonths } from "@canny_ecosystem/utils/constant";
import { getYears } from "@canny_ecosystem/utils";

export function ESIReportSearchFilter({
  disabled,
  projectArray,
  projectSiteArray,
}: {
  ...
  const initialFilterParams: ESIReportFilters = {
    project: "",
    project_site: "",
    start_month: "",
    start_year: "",
