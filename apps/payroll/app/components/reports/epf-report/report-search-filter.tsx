...
import type { EPFReportFilters } from "@/routes/_protected+/reports+/epf+/_index";
import { payoutMonths } from "@canny_ecosystem/utils/constant";
import { getYears } from "@canny_ecosystem/utils";

export function EPFReportSearchFilter({
  disabled,
  projectArray,
  projectSiteArray,
}: {
  ...
  const isSubmitting =
    ...
    (navigation.state === "loading" &&
      navigation.location.pathname === "/reports/epf" &&
