  ...
  <Document title={`Nomination Form - ${formatDateTime(Date.now())}`}>
    <Page size="A4" style={styles.page}>
      ...
      <Text style={styles.subtitle}>
        ...
        (Paragraph 33 and 61 (1) of the Employees Provident Fund Scheme 1952 and
      ...
      <View style={styles.formField}>
        ...
        <Text style={[styles.label, { width: "15%", marginLeft: 20 }]}>
          3. Account No.
        </Text>
      ...
      <View style={styles.table}>
        <View style={styles.tableHeader}>
          ...
          <Text style={[styles.tableCell, { width: "15%" }]}>
            Total amount or share of accumulations
          </Text>
          <Text style={[styles.tableCell, { width: "20%" }]}>
            If the nominee is minor, guardian details
          </Text>
        </View>
      ...
      <Text style={styles.certification}>
        ...
        Employees Provident Fund Scheme 1952 and should I acquire a family
      ...
      <Text style={{ fontSize: 9, marginBottom: 10 }}>
        I hereby furnish below particulars of the members of my family who would
      ...
      <View style={styles.employerSection}>
        ...
        <Text style={{ fontSize: 9, marginBottom: 10 }}>
          Certified that the above declaration and nomination has been signed /
          thumb impressed before me by Shri / Smt./
          ...
          entries have been read over to him/her by me and got confirmed by
          him/her.
        </Text>
