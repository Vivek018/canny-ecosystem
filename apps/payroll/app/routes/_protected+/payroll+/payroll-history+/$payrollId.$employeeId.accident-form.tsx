    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.table}>
        <View style={styles.tableRow}>
          <View style={styles.tableColFull}>
            <Text style={styles.label}>
              Nature of Industry/ business Address of premises where accident
              happened
            </Text>
            <View style={styles.inputField} />
          </View>
      ...
      <View style={styles.table}>
        <View style={styles.tableRow}>
          <View style={styles.tableCol}>
            <Text style={styles.label}>
              Nature and extent of injury (e.g., total loss of finger, fracture
              of leg. scald etc.)
            </Text>
            <View style={styles.inputField} />
          </View>
          <View style={styles.tableCol}>
            <Text style={styles.label}>
              Location of injury (right/left hand, leg or eye etc.)
            </Text>
            <View style={styles.inputField} />
          </View>
        </View>
      ...
      <View style={styles.table}>
        ...
        <View style={styles.tableRow}>
          <View style={styles.tableColFull}>
            <Text style={styles.label}>
              If the accident is not fatal state whether the injured person has
              returned to work? If so, give date & hour of return to work
            </Text>
            <View style={styles.inputField} />
          </View>
        </View>
        <View style={styles.tableRow}>
          <View style={styles.tableColFull}>
            <Text style={styles.label}>
              Dr. or dispensary from where injured person received or receiving
              treatment.
            </Text>
            <View style={styles.inputField} />
          </View>
        ...
        <View style={styles.tableRow}>
          <View style={styles.tableColFull}>
            ...
            <View style={styles.inputField} />
            <Text style={styles.label}>
              Brief description of the accident Note: -In case the accident
              happened while meeting emergency. indicate in the description
              above its nature and also whether the injured person at time of
              accident was employed for the purpose of his employer's trade or
              business in or about the premises which the accident took place.
            </Text>
      ...
      <View style={styles.table}>
        <View style={styles.tableRow}>
          <View style={styles.tableCol}>
            <Text style={styles.label}>
              Whether wages in full or part are payable to him for the day of
              accident
            </Text>
      ...
      <View style={styles.table}>
        <View style={styles.tableRow}>
          <View style={styles.tableColFull}>
            <Text style={styles.label}>
              Whether the injured person was on the day accident an employee as
              defined in Sec 2 (9) of the Act and whether contribution was
              payable by him/her for the day on which the accident occurred.
            </Text>
            <View style={styles.inputField} />
          </View>
        </View>
      ...
      <View style={styles.table}>
        <View style={styles.tableRow}>
          <View style={styles.tableColFull}>
            <Text style={styles.label}>
              (a) CAUSE OF ACCIDENT if caused by Machinery
            </Text>
            <Text style={styles.label}>
              (1) Give name of machine and part causing the accident, and:
            </Text>
            <View style={styles.yesNo}>
              <View style={styles.yesNoLabel}>
                <Text>Yes</Text>
            ...
            <View style={styles.inputField} />
            <Text style={styles.label}>
              (c) Was the injured person at that time of accident acting in
              contravention of?
            </Text>
            <Text style={styles.label}>
              the provisions of any law applicable to him or
              ................................................................
              any orders given by or on behalf of his
              employer............................................................
              acting without instruction from his
              employer..................................................................
            </Text>
            <View style={styles.inputField} />
            <Text style={styles.label}>
              (d) In case reply to C (1), (2) or (3) is YES, state whether the
              act was done for the purpose of and in connection with the
      ...
      <View style={styles.table}>
        <View style={styles.tableRow}>
          <View style={styles.tableColFull}>
            <Text style={styles.label}>
              In case the accident happened while TRAVELLING in the employer's
              transport, state whether the injured person was travelling.
            </Text>
            <Text style={styles.label}>
            ...
            <Text style={styles.label}>
              3. The transport was being operated or on behalf of the employer
              or some other person by whom it is provided in pursuance of
            ...
            <Text style={styles.label}>
              4. The vehicle was being/not being operated in the ordinary course
              of public transport
            </Text>
            <View style={styles.yesNo}>
              <View style={styles.yesNoLabel}>
