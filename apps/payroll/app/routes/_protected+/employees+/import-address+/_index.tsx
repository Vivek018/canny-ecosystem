...
export const IMPORT_EMPLOYEE_ADDRESS = [
  "address-map-headers",
  "address-validate-imported-data",
];

export const STEP = "step";

const SESSION_KEY_PREFIX = "multiStepEmployeeAddressImport_step_";
...
export default function EmployeeAddressImportFieldMapping() {
  ...
  const IMPORT_TAG = IMPORT_EMPLOYEE_ADDRESS[step - 1];
  const currentSchema = schemas[step - 1];
