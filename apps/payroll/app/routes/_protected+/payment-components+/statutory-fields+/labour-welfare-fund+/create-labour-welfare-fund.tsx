...
export default function CreateLabourWelfareFund({ updateValues }: {
        ...
        <section className="p-4 w-full">
            <FormProvider context={form.context}>
                <Form method="POST" {...getFormProps(form)} className="flex flex-col">
                    <Card>
                        <CardHeader>
                            <CardTitle className="text-3xl">{replaceDash(LABOUR_WELFARE_FUND_TAG)}</CardTitle>
                            <CardDescription>
                                {LABOUR_WELFARE_FUND_TAG.split("-")[0]} labour welfare fund of a company that will be
                        ...
                        <CardContent>
                            ...
                            <Field
                                inputProps={{
                                    ...getInputProps(fields.employee_contribution, { type: "number" }),
                                    className: "capitalize",
                            ...
                            <Field
                                inputProps={{
                                    ...getInputProps(fields.employer_contribution, { type: "number" }),
                                    className: "capitalize",
