import { FilterList } from "@/components/reports/sb-report/monthly/filter-list";
import { SBReportSearchFilter } from "@/components/reports/sb-report/monthly/report-search-filter";
import { columns } from "@/components/reports/sb-report/monthly/table/columns";
import { DataTable } from "@/components/reports/sb-report/monthly/table/data-table";
...
export default function StatutoryBonusReport() {
  const {
    data,
    count,
    query,
