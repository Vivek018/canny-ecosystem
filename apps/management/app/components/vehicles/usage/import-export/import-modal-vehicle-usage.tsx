...
export const ImportVehicleUsageModal = () => {
  ...
  const isOpen =
    searchParams.get("step") === modalSearchParamNames.import_vehicle_usage;
  ...
  const handleFileSubmit = () => {
    if (eligibleFileSize && selectedFile) {
      navigate("/vehicles/usage/import-data", {
  ...
  const downloadDemoCsv = (
    ...
    link.setAttribute("download", "Vehicle-Usage-Format");
