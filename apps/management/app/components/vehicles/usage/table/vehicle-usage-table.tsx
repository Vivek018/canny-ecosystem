...
import { VehicleUsageTableHeader } from "./vehicle-usage-table-header";
...
export function VehicleUsageTable<TData, TValue>({
  ...
  useEffect(() => {
    ...
    setSelectedRows(rowArray as VehicleUsageDataType[]);
  }, [rowSelection]);
  ...
  return (
    ...
    >
              ...
              <TableRow className={cn(!tableLength && "border-none")}>
                ...
                >
                  <div className="flex flex-col items-center gap-1">
                    <h2 className="text-xl">No Usage Found.</h2>
                    <p
                      className={cn(
      ...
      <ExportBar
        ...
        data={selectedRowsData as VehicleUsageDataType[]}
