...
export const DeleteVehicleUsage = ({
  id,
  vehicleId,
}: {
  id: string;
  ...
  const handleCancleVehicleUsage = () => {
    setInputError([]);
    setInputValue("");
    setLoading(false);
  };
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            Usage and remove it's data from our servers.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <div className="py-4">
        ...
        <AlertDialogFooter>
          <AlertDialogCancel onClick={handleCancleVehicleUsage}>
            Cancel
          </AlertDialogCancel>
          <AlertDialogAction
            className={cn(buttonVariants({ variant: "destructive" }))}
            onClick={handleDeleteVehicleUsage}
            onSelect={handleDeleteVehicleUsage}
          >
