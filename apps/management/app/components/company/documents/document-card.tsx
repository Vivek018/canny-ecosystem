...
export default function DocumentCard({ documentData }: {
    ...
    return (
        ...
        >
            <div
                className="flex items-center justify-center bg-muted/30 hover:bg-muted/50 h-60 w-full"
            >
            ...
            <div className="px-4 py-3 flex justify-between items-center border-t">
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent sideOffset={8} align="end">
                        <DropdownMenuItem
                            onClick={() => documentData.url && handleDownload(documentData.url, `${documentData.name}.pdf`)}
                            className={cn(
                                "hidden",
                                hasPermission(role, `${updateRole}:${attribute.companyDocuments}`) &&
                                "flex",
                            )}
                        >
                            Download
