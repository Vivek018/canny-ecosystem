...
export const DeleteEmployeeDocument = ({
  ...
  const handleCancelEmployeeDocument = () => {
    setInputError([]);
    setInputValue("");
    setLoading(false);
  };

  const handleDeleteEmployeeDocument = (
    ...
    <AlertDialog>
      <AlertDialogTrigger
        className={cn(
          ...
          hasPermission(role, `${deleteRole}:${attribute.employeeDocuments}`) &&
            "flex",
        )}
      >
        Delete document
      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter>
          <AlertDialogCancel onClick={handleCancelEmployeeDocument}>
            Cancel
          </AlertDialogCancel>
          <AlertDialogAction
            className={cn(buttonVariants({ variant: "destructive" }))}
            onClick={handleDeleteEmployeeDocument}
            onSelect={handleDeleteEmployeeDocument}
          >
