import type { DashboardFilters } from "@canny_ecosystem/supabase/queries";
import { Button } from "@canny_ecosystem/ui/button";
import { Icon } from "@canny_ecosystem/ui/icon";
import { defaultYear } from "@canny_ecosystem/utils";
import { useSearchParams } from "@remix-run/react";

export function FilterList({ filters }: { filters: DashboardFilters }) {
  const [searchParams, setSearchParams] = useSearchParams();

  const defaultFilters = filters?.year
    ? filters
    : {
