...
export const ImportEmployeeDetailsModal = () => {
  ...
  const isOpen =
    searchParams.get("step") === modalSearchParamNames.import_employee_details;
  ...
  const downloadDemoCsv = (
    ...
    link.setAttribute("download", "Employee-Details-Format");
