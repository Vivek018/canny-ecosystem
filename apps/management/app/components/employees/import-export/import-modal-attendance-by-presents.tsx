...
export const ImportEmployeeAttendanceByPresentsModal = () => {
  ...
  const handleFileSubmit = () => {
    if (eligibleFileSize && selectedFile) {
      navigate("/time-tracking/attendance/import-by-presents", {
  ...
  const downloadDemoCsv = (
    ...
    link.setAttribute("download", "Attendance-By-Presents-Format");
