...
export const ImportEmployeeProjectAssignmentModal = () => {
  ...
  const isOpen =
    ...
    modalSearchParamNames.import_project_assignments;
  ...
  const handleFileSubmit = () => {
    if (eligibleFileSize && selectedFile) {
      navigate("/employees/import-project-assignments", {
  ...
  const downloadDemoCsv = (
    ...
    link.setAttribute("download", "Employee-Project-Assignment-Format");
