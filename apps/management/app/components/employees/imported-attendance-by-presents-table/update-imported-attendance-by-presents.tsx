...
import {
  ImportSingleEmployeeAttendanceByPresentsDataSchema,
} from "@canny_ecosystem/utils";
import { useState } from "react";

export const UpdateImportedEmployeeAttendanceByPresents = ({
  indexToUpdate,
  dataToUpdate,
}: {
  indexToUpdate: number;
  dataToUpdate: ImportEmployeeAttendanceByPresentsDataType;
}) => {
  ...
  const handleUpdate = () => {
    const parsedResult =
      ImportSingleEmployeeAttendanceByPresentsDataSchema.safeParse(data);
