  ...
  const handleDeletePayroll = (
    ...
    if (inputValue === DELETE_TEXT) {
      ...
      submit(
        ...
        {
          method: "post",
          action: `/payroll/run-payroll/${payrollId}/delete-payroll`,
          replace: true,
        },
      );
    } else {
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            payroll and remove it's data from our servers.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <div className="py-4">
        ...
        <AlertDialogFooter>
          <AlertDialogCancel onClick={handleCancelPayroll}>
            Cancel
          </AlertDialogCancel>
          <AlertDialogAction
            className={cn(buttonVariants({ variant: "destructive" }))}
            onClick={handleDeletePayroll}
            onSelect={handleDeletePayroll}
          >
