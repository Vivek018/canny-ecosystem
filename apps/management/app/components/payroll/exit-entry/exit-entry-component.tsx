...
import { exitEntryColumns } from "./payroll-entry-table/columns";
import { ExitEntryDataTable } from "./payroll-entry-table/data-table";

export function ExitEntryComponent({
  data,
  payrollData,
  env,
  noButtons = false,
  ...
  data: ExitsPayrollEntriesWithEmployee[];
