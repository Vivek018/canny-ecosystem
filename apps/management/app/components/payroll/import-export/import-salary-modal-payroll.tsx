...
export const ImportSalaryPayrollModal = () => {
  ...
  const isOpen =
    searchParams.get("step") === modalSearchParamNames.import_salary_payroll;
  ...
  const handleFileSubmit = () => {
    if (eligibleFileSize && selectedFile) {
      navigate("/payroll/run-payroll/import-salary-payroll", {
