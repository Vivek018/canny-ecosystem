...
export function AssistantButton() {
  ...
  return (
    <Link
      to="/chat"
      className={cn(buttonVariants({ variant: "ghost" }), "relative min-w-[265px] w-full justify-start text-sm text-muted-foreground sm:pr-12 md:w-40 lg:w-64 p-0 hover:bg-transparent font-normal no-drag", pathname === "/chat" && "text-accent-foreground")}
    >
