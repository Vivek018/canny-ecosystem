...
export const AttendanceRegister = ({
  ...
  const updatedData = selectedRows.map((employee) => {
    ...
    const totalHours = totalPresents * 8;
  ...
  const generateAttendanceExcel = async (updatedData: any[]) => {
      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction
            ...
            onClick={() => generateAttendanceExcel(updatedData)}
            onSelect={() => generateAttendanceExcel(updatedData)}
          >
            Create
          </AlertDialogAction>
        </AlertDialogFooter>
