...
import { HolidaysTableHeader } from "./data-table-header";

interface HolidaysDataTableProps<TData, TValue> {
  columns: ColumnDef<TData, TValue>[];
  data: TData[];
}

export function HolidaysDataTable<TData, TValue>({
  columns,
  data,
}: HolidaysDataTableProps<TData, TValue>) {
