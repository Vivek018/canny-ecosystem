...
export const DeleteLeaveType = ({ id }: { id: string }) => {
  const { role } = useUser();
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            Leave Type and remove it's data from our servers.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <div className="p-4">
        ...
        <AlertDialogFooter>
          <AlertDialogCancel onClick={handleCancelLeaveType}>
            Cancel
          </AlertDialogCancel>
          <AlertDialogAction
            className={cn(buttonVariants({ variant: "destructive" }))}
            onClick={handleDeleteLeaveType}
            onSelect={handleDeleteLeaveType}
          >
