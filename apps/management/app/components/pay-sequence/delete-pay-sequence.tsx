...
export const DeletePaySequence = ({ id }: { id: string }) => {
  const { role } = useUser();
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This action cannot be undone. This will permanently delete your Pay
            Sequence and remove it's data from our servers.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <div className="py-4">
        ...
        <AlertDialogFooter>
          <AlertDialogCancel onClick={handleCancelPaySequence}>
            Cancel
          </AlertDialogCancel>
          <AlertDialogAction
            className={cn(buttonVariants({ variant: "destructive" }))}
            onClick={handleDeletePaySequence}
            onSelect={handleDeletePaySequence}
          >
