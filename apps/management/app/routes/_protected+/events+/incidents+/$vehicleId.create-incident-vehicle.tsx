...
export async function loader({ request, params }: LoaderFunctionArgs) {
  ...
  return json({ vehicleId, companyId });
}
...
export default function RegisterIncidentVehicle({
  updateValues,
}: {
  updateValues?: IncidentsDatabaseUpdate | null;
}) {
  const { vehicleId, companyId } = useLoaderData<typeof loader>();
  ...
  const [form, fields] = useForm({
    ...
    defaultValue: {
      ...initialValues,
      vehicle_id: initialValues.vehicle_id ?? vehicleId,
        ...
        <Form method="POST" {...getFormProps(form)} className="flex flex-col">
          <Card>
            ...
            <CardContent>
              ...
              <input
                {...getInputProps(fields.vehicle_id, { type: "hidden" })}
              />
              <input
