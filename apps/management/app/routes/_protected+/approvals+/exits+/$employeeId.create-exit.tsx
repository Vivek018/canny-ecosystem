...
export default function CreateExit({
  ...
  useEffect(() => {
    ...
    navigate(`/approvals/exits?recently_added=${recentlyAddedFilter[0]}`, { replace: true });
  }, [actionData]);
        ...
        <Form method="POST" {...getFormProps(form)} className="flex flex-col">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {EXIT_TAG.split("-")[0]} exit of a company that will be central
