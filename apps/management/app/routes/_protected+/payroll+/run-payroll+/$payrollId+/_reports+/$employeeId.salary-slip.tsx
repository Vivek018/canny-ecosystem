...
const SalarySlipPDF = ({ data }: { data: DataType }) => {
  ...
  const getFullAddress = (emp: any) => {
    ...
    const address =
      (hasAddress(employeeProjectAssignmentData?.salary_location)
        ? employeeProjectAssignmentData?.salary_location
        : null) ||
      (hasAddress(employeeProjectAssignmentData?.project_assignment_location)
        ...
        : null) ||
      (hasAddress(data?.companyData) ? data?.companyData : null);
