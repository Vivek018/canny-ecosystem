...
export const EmployeeFiltersSchema = z.object({
  ...
  dob_start: z
    ...
    .optional()
    .describe(
      "Date of birth start range in YYYY-MM-DD format. Example: 1990-01-01",
    ),
  dob_end: z
    .string()
    .optional()
    .describe(
      "Date of birth end range in YYYY-MM-DD format. Example: 2000-12-31",
    ),
  gender: z.enum(genderArray).optional().describe("Gender of the individual."),
  education: z
    .enum(educationArray)
    .optional()
    .describe("Highest level of education."),
  status: z.enum(statusArray).optional().describe("Current employment status."),
  project: z
    .string()
    .optional()
  ...
  assignment_type: z
    .enum(assignmentTypeArray)
    .optional()
    .describe("Type of assignment."),
  position: z.enum(positionArray).optional().describe("Job position or title."),
  skill_level: z
    .enum(skillLevelArray)
    .optional()
  ...
  doj_start: z
    ...
    .optional()
    .describe(
      "Start of Date of Joining range in YYYY-MM-DD. Example: 2020-01-01",
    ),
  doj_end: z
    .string()
    .optional()
    .describe(
      "End of Date of Joining range in YYYY-MM-DD. Example: 2023-12-31",
    ),
  dol_start: z
    .string()
    .optional()
    .describe(
      "Start of Date of Leaving range in YYYY-MM-DD. Example: 2022-01-01",
    ),
  dol_end: z
    .string()
    .optional()
    .describe(
      "End of Date of Leaving range in YYYY-MM-DD. Example: 2024-11-30",
    ),
});
